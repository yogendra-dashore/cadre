...
public class ActivityListResponse {
	...
	public ActivityListResponse(BigInteger id, BigInteger subCategoryId, String performanceOutcome,
	...
	public String toString() {
		return "ActivityContentListResponse [id=" + id + ", subCategoryId=" + subCategoryId + ", performanceOutcome="
